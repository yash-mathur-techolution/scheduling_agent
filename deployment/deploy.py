...
# configs = Config()
configs = dict()
configs["CLOUD_PROJECT"] = os.getenv("GOOGLE_CLOUD_PROJECT")
configs["CLOUD_LOCATION"] = os.getenv("GOOGLE_CLOUD_LOCATION")

STAGING_BUCKET = f"gs://{configs["CLOUD_PROJECT"]}-adk-customer-service-staging"

AGENT_WHL_FILE = "./drive_service-0.1.0-py3-none-any.whl"
